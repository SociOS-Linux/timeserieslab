...
Linux-native lab workspace for time-series, forecasting, and signal feature experiments for SocioProphet services.

## Role in the Holmes lab family

`timeserieslab` is the first governed pilot lab for the Holmes signal-intelligence stack. It emits a `functional-service.v1` manifest that can be consumed by:

- `SocioProphet/holmes` as the signal-intelligence product surface;
