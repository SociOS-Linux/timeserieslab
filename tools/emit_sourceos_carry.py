...
def main() -> int:
    ...
    carry = {
        ...
        "carryId": "urn:srcos:model-carry:functional-service:timeserieslab-holmes-pilot",
        "displayName": "TimeSeriesLab Holmes Pilot Carry Profile",
        "service": {
            "id": service["id"],
            "ownerRepository": service["ownerRepository"],
            "function": manifest["function"],
            "manifestRef": "SociOS-Linux/timeserieslab:manifests/functional-service.json"
        },
        "sourceos": {
        ...
        "runtime": {
            ...
            "launchProfileRef": "urn:srcos:launch-profile:timeserieslab-holmes-pilot:disabled-v0",
        ...
        "evidence": {
            ...
            "smokeReceiptRef": "SociOS-Linux/timeserieslab:evidence/smoke-receipt.example.json"
        },
        "integrations": {
